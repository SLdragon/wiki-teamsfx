...
1. Put the `web.config` file to the root of the project if your project is using nodeJS. You can find the template file from [here](https://github.com/projectkudu/kudu/blob/master/Kudu.Core/Scripts/iisnode.config.template) and example from [here](https://github.com/Azure-Samples/nodejs-docs-hello-world/blob/master/web.config) and [more examples from our repo](https://github.com/search?q=repo%3AOfficeDev%2FTeamsFx%20web.config&type=code). If your project is built by Dotnet, skip this step.
